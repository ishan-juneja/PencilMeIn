...
#     try: #try to login
#         redirect_uri = flask.url_for('google_authorize', _external=True) #external window to popup login for google
...
def print_index_table():
    return ('<table>' +
            '<tr><td><a href="/get_creds">Get creds</a></td>' +
            '<tr><td><a href="/calendar">Test calendar request</a></td>' +
